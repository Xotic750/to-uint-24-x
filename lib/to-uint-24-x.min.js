 ...
 * @module to-uint-24-x
 */
"use strict";var toNumber=_dereq_("to-number-x").toNumber2018,modulo=_dereq_("modulo-x"),sign=_dereq_("math-sign-x").sign2018,numberIsFinite=_dereq_("is-finite-x");module.exports=function toUint24(argument){var number=toNumber(argument);return 0===number||!1===numberIsFinite(number)?0:modulo(sign(number)*Math.floor(Math.abs(number)),16777216)}},{"is-finite-x":9,"math-sign-x":16,"modulo-x":17,"to-number-x":25}],2:[function(_dereq_,module,exports){/**
 ...
 * @module modulo-x
 */
"use strict";module.exports=function modulo(dividend,divisor){var remain=dividend%divisor;return Math.floor(remain>=0?remain:remain+divisor)}},{}],18:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":23,"to-string-x":28}],23:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),Rx=_dereq_("cached-constructors-x").RegExp,reRight2016=new Rx("["+_dereq_("white-space-x").string2016+"]+$"),reRight2018=new Rx("["+_dereq_("white-space-x").string2018+"]+$"),replace="".replace,$trimRight2018=function trimRight2018(string){return replace.call(requireCoercibleToString(string),reRight2018,"")};module.exports={trimRight:$trimRight2018,trimRight2016:function trimRight2016(string){return replace.call(requireCoercibleToString(string),reRight2016,"")},trimRight2018:$trimRight2018}},{"cached-constructors-x":3,"require-coercible-to-string-x":22,"white-space-x":33}],31:[function(_dereq_,module,exports){/**
